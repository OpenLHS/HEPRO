 ...
 * [HEPRO.yml](HEPRO.yml)
     * Determines how your purl.obolibrary.org/obo/HEPRO/ redirects will be handled
     ...
     * Paste in the contents of [HEPRO.yml](HEPRO.yml)
 ...
 * [HEPRO.md](HEPRO.md)
     ...
     * Paste in the contents of [HEPRO.md](HEPRO.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
